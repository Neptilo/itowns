<a name="2.47.0"></a>
# [2.47.0](https://github.com/iTowns/itowns/compare/v2.45.1...v2.47.0) (2026-09-16)
...
* bump itowns dependencies to latest versions ([395669d](https://github.com/iTowns/itowns/commit/395669d))
* bump proj4 from 2.19.10 to 2.20.4 ([ec9487f](https://github.com/iTowns/itowns/commit/ec9487f))
...
* **demo:** added an end-user oriented demonstration of itowns capabilities ([#2653](https://github.com/iTowns/itowns/issues/2653)) ([f452ad3](https://github.com/iTowns/itowns/commit/f452ad3))
* **demo:** Redesign the demo, integrate into examples page ([#2773](https://github.com/iTowns/itowns/issues/2773)) ([86df5ce](https://github.com/iTowns/itowns/commit/86df5ce))
...
* **examples:** Revamp examples page style ([#2754](https://github.com/iTowns/itowns/issues/2754)) ([0d37653](https://github.com/iTowns/itowns/commit/0d37653))
* export type definitions for the itowns package ([f256f47](https://github.com/iTowns/itowns/commit/f256f47))
* **Feature2Mesh:** orientation of instanced models -> using up and front vector ([1f7afe8](https://github.com/iTowns/itowns/commit/1f7afe8))
* **geographic:** let user import single modules ([f160270](https://github.com/iTowns/itowns/commit/f160270))
* implement line extrusion as cylinders ([c68762d](https://github.com/iTowns/itowns/commit/c68762d))
* implement option to make extruded polygon roofs flat ([177d892](https://github.com/iTowns/itowns/commit/177d892))
...
* **pointcloud:** Add adaptive size mode ([#2666](https://github.com/iTowns/itowns/issues/2666)) ([8b62da7](https://github.com/iTowns/itowns/commit/8b62da7))
* **pointcloud:** Add events and finest visibility tracking ([#2721](https://github.com/iTowns/itowns/issues/2721)) ([81d011c](https://github.com/iTowns/itowns/commit/81d011c))
* **pointcloud:** add load, error and dispose events ([4dedf1d](https://github.com/iTowns/itowns/commit/4dedf1d))
* **PointCloud:** lazy hierarchy and unified node model ([4da7bd2](https://github.com/iTowns/itowns/commit/4da7bd2))
...
* revamp examples page ([#2583](https://github.com/iTowns/itowns/issues/2583)) ([39a1121](https://github.com/iTowns/itowns/commit/39a1121))
* **SkyController:** new simple sky mode, improvements and bug fixes ([#2790](https://github.com/iTowns/itowns/issues/2790)) ([3db389a](https://github.com/iTowns/itowns/commit/3db389a))
* **style:** implement runtime style changes for feature meshes ([74811a1](https://github.com/iTowns/itowns/commit/74811a1))
* **TMSSource:** remove extra $ in url ([#2787](https://github.com/iTowns/itowns/issues/2787)) ([e541def](https://github.com/iTowns/itowns/commit/e541def))
* **View:** Add shadows support ([43b1587](https://github.com/iTowns/itowns/commit/43b1587))
...
* **3dtiles:** set cache top limit to 1GB ([60a3e3c](https://github.com/iTowns/itowns/commit/60a3e3c))
...
* **cog:** Fix blank texture size ([e3f0b8b](https://github.com/iTowns/itowns/commit/e3f0b8b))
* **cog:** Fix fallback texture format ([4452673](https://github.com/iTowns/itowns/commit/4452673))
...
* **demo:** demo not served in production environment ([#2759](https://github.com/iTowns/itowns/issues/2759)) ([8b89a8c](https://github.com/iTowns/itowns/commit/8b89a8c))
* **demo:** relative paths changing under certain serving conditions ([#2760](https://github.com/iTowns/itowns/issues/2760)) ([332fb01](https://github.com/iTowns/itowns/commit/332fb01))
...
* **example:** fix destroy gui when we change source dataset on pointcloud examples ([7867060](https://github.com/iTowns/itowns/commit/7867060))
* **example:** misc_instancing -> use default values for THREE.CylinderGeometry() and THREE.SphereGeometry() ([12c3f09](https://github.com/iTowns/itowns/commit/12c3f09))
* **example:** misc_instancing and realistic lightning ([df885c7](https://github.com/iTowns/itowns/commit/df885c7))
* **examples:** fix broken copc loader example ([b63980b](https://github.com/iTowns/itowns/commit/b63980b))
* **examples:** fix duplicating panel bug, sessionStorage bugs and responsive design ([#2763](https://github.com/iTowns/itowns/issues/2763)) ([29cddd2](https://github.com/iTowns/itowns/commit/29cddd2))
* **examples:** Fix examples ([e83d835](https://github.com/iTowns/itowns/commit/e83d835))
* **examples:** fix examples style regression ([#2767](https://github.com/iTowns/itowns/issues/2767)) ([e9b5f80](https://github.com/iTowns/itowns/commit/e9b5f80))
...
* **examples:** wrong json layer properties ([aca1a70](https://github.com/iTowns/itowns/commit/aca1a70))
* **example:** use original opensm source ([7f3abf4](https://github.com/iTowns/itowns/commit/7f3abf4))
* **export:** Add missing PointCloudNode export ([#2736](https://github.com/iTowns/itowns/issues/2736)) ([198b208](https://github.com/iTowns/itowns/commit/198b208))
* fix 3D meshes not showing due to wrong extent check ([9364cb2](https://github.com/iTowns/itowns/commit/9364cb2))
* fix fully transparent Mapbox buildings by preserving material intrinsic opacity ([49c69fc](https://github.com/iTowns/itowns/commit/49c69fc))
* Fix monorepo typescript issues ([88aea43](https://github.com/iTowns/itowns/commit/88aea43))
* fix resize of engine composer ([18666c0](https://github.com/iTowns/itowns/commit/18666c0))
* fix typechecking issues ([#2771](https://github.com/iTowns/itowns/issues/2771)) ([597db88](https://github.com/iTowns/itowns/commit/597db88))
* fix wrong diffuse color on terrain ([a98bbb9](https://github.com/iTowns/itowns/commit/a98bbb9))
* fix wrong install path for dependencies ([c6f5964](https://github.com/iTowns/itowns/commit/c6f5964))
* **geographic:** fix geographic types generation ([#2742](https://github.com/iTowns/itowns/issues/2742)) ([49e9f90](https://github.com/iTowns/itowns/commit/49e9f90))
* **geotiff:** Fix geotiff sample ([d856fe1](https://github.com/iTowns/itowns/commit/d856fe1))
* **globe:** refactor dynamic near & far ([#2699](https://github.com/iTowns/itowns/issues/2699)) ([f531af6](https://github.com/iTowns/itowns/commit/f531af6))
* **layers:** per material uniform setting ([90159bd](https://github.com/iTowns/itowns/commit/90159bd))
* make launch configuration use SwiftShader for CI compatibility ([c66b942](https://github.com/iTowns/itowns/commit/c66b942))
* **material:** set transparency when some points classes are disabled ([f26f050](https://github.com/iTowns/itowns/commit/f26f050))
* **OBB:** fix ts ([0d7bca2](https://github.com/iTowns/itowns/commit/0d7bca2))
* **OGC3DTilesLayer:** accept 'classification' with lowercase c ([#2806](https://github.com/iTowns/itowns/issues/2806)) ([56f189d](https://github.com/iTowns/itowns/commit/56f189d))
...
* **PartialTexture:** fix bug when first texture is empty ([c4a77f0](https://github.com/iTowns/itowns/commit/c4a77f0))
* **Picking:** Fix traversePickingCircle for pickPointsAt ([d343727](https://github.com/iTowns/itowns/commit/d343727))
* **picking:** make object picking robust by comparing alpha instead of colors ([2987cb1](https://github.com/iTowns/itowns/commit/2987cb1))
...
* **PlanarLayer:** Delete extent from globalExtentTMS const (fix [#2244](https://github.com/iTowns/itowns/issues/2244)) ([7fc4327](https://github.com/iTowns/itowns/commit/7fc4327))
...
* **pointcloud:** Fix pointcloud debugBoxes ([#2782](https://github.com/iTowns/itowns/issues/2782)) ([bfbe1ba](https://github.com/iTowns/itowns/commit/bfbe1ba))
* **PointCloud:** flickering and matrixInverse.copy() ([194e371](https://github.com/iTowns/itowns/commit/194e371))
* **PointCloudLayer:** move debug functions to Debug/PointCloudDebug ([43eaeaf](https://github.com/iTowns/itowns/commit/43eaeaf))
* **PointCloudNode:** fix id unicity for copc and ept nodes ([76cf6bd](https://github.com/iTowns/itowns/commit/76cf6bd))
...
* **PointCloudNode:** use copy instead of clone ([2fd1810](https://github.com/iTowns/itowns/commit/2fd1810))
...
* **potree2:** incorrect node info ([4e9da4d](https://github.com/iTowns/itowns/commit/4e9da4d))
...
* **rendering:** fix aerial perspective logarithmic depth bug ([b800b98](https://github.com/iTowns/itowns/commit/b800b98))
* **rendering:** remove tone mapping in realistic lighting & adapt shaders ([54cc94a](https://github.com/iTowns/itowns/commit/54cc94a))
...
* **scheduler:** use different URI construct due to non-standard webpack handling ([1d4b404](https://github.com/iTowns/itowns/commit/1d4b404))
...
* **test:** wrong tile picking ([af9b392](https://github.com/iTowns/itowns/commit/af9b392))
* **textureConverter:** handle no linear float texture ([db4f536](https://github.com/iTowns/itowns/commit/db4f536))
...
* **types:** Fix types output location ([#2737](https://github.com/iTowns/itowns/issues/2737)) ([de13f85](https://github.com/iTowns/itowns/commit/de13f85))
...
* **VectorTileParser:** generate generic mvtStyle when not existing ([db45264](https://github.com/iTowns/itowns/commit/db45264))
* **view:** consider user provided renderer at view disposal ([2843ca9](https://github.com/iTowns/itowns/commit/2843ca9))
* **view:** improve view disposal ([5e91535](https://github.com/iTowns/itowns/commit/5e91535))
* **vpc:** fixes: typos and correct bounds for OBBes ([bbdd27d](https://github.com/iTowns/itowns/commit/bbdd27d))
* **VpcLayer:** fix 'root' nodes -> add them all to layer.object3d ([483bfa8](https://github.com/iTowns/itowns/commit/483bfa8))
* **VpcLayer:** fix root Node OBB calculation with huge extent ([ad8512d](https://github.com/iTowns/itowns/commit/ad8512d))
...
* zoom-dependent properties on vector rasterisation ([bf52141](https://github.com/iTowns/itowns/commit/bf52141))
...
* **Potree:** add new data set v1.7 for sub hierarchy tests ([ceb188e](https://github.com/iTowns/itowns/commit/ceb188e))
...
* centralise 2D rendering context ([#2825](https://github.com/iTowns/itowns/issues/2825)) ([23ef24a](https://github.com/iTowns/itowns/commit/23ef24a))
* **CRS:** move proj4Cache to CRS and use it where it's needed ([876bf16](https://github.com/iTowns/itowns/commit/876bf16))
* **Errors:** clean up catch path of errors ([4fa9b47](https://github.com/iTowns/itowns/commit/4fa9b47))
...
* migrate MainLoop to TypeScript ([#2675](https://github.com/iTowns/itowns/issues/2675)) ([844cd4f](https://github.com/iTowns/itowns/commit/844cd4f))
...
* **PointCloud:** add OBBes to Group at Layer and not at Node ([5d32483](https://github.com/iTowns/itowns/commit/5d32483))
...
* **pointcloud:** homogenize point cloud nodes and fix potree issue ([#2687](https://github.com/iTowns/itowns/issues/2687)) ([9070b66](https://github.com/iTowns/itowns/commit/9070b66))
...
* **Source:** refactor extentInsideLimit() to hasData() ([3c64961](https://github.com/iTowns/itowns/commit/3c64961))
* **style:** move style.point.model to its own category model ([e0edb03](https://github.com/iTowns/itowns/commit/e0edb03))
...
* bump dev dependencies to latest version ([edc8544](https://github.com/iTowns/itowns/commit/edc8544))
* bump vulnerable dependencies ([117b278](https://github.com/iTowns/itowns/commit/117b278))
...
* **deps-dev:** bump [@babel](https://github.com/babel)/plugin-transform-modules-systemjs ([4f6333b](https://github.com/iTowns/itowns/commit/4f6333b))
* **deps-dev:** bump [@xmldom](https://github.com/xmldom)/xmldom from 0.8.11 to 0.8.12 ([2a66c47](https://github.com/iTowns/itowns/commit/2a66c47))
* **deps-dev:** bump [@xmldom](https://github.com/xmldom)/xmldom from 0.8.12 to 0.8.13 ([5a28502](https://github.com/iTowns/itowns/commit/5a28502))
* **deps-dev:** bump basic-ftp from 5.2.0 to 5.2.2 ([08e08f5](https://github.com/iTowns/itowns/commit/08e08f5))
* **deps-dev:** bump fast-uri from 3.1.0 to 3.1.2 ([d290144](https://github.com/iTowns/itowns/commit/d290144))
* **deps-dev:** bump follow-redirects from 1.15.11 to 1.16.0 ([5673508](https://github.com/iTowns/itowns/commit/5673508))
* **deps-dev:** bump handlebars from 4.7.8 to 4.7.9 ([2451347](https://github.com/iTowns/itowns/commit/2451347))
* **deps-dev:** bump http-proxy-middleware from 2.0.7 to 2.0.9 ([2fae44b](https://github.com/iTowns/itowns/commit/2fae44b))
* **deps-dev:** bump ip-address from 10.1.0 to 10.2.0 ([bcd9ce1](https://github.com/iTowns/itowns/commit/bcd9ce1))
...
* **deps-dev:** bump webpack-dev-server from 5.2.3 to 5.2.4 ([8776c04](https://github.com/iTowns/itowns/commit/8776c04))
...
* **deps:** bump lodash from 4.17.23 to 4.18.1 ([11fdbe0](https://github.com/iTowns/itowns/commit/11fdbe0))
* **deps:** bump on-headers and compression ([8924e73](https://github.com/iTowns/itowns/commit/8924e73))
* **deps:** bump picomatch ([#2728](https://github.com/iTowns/itowns/issues/2728)) ([683b293](https://github.com/iTowns/itowns/commit/683b293))
* **deps:** bump protocol-buffers-schema from 3.6.0 to 3.6.1 ([9c45d72](https://github.com/iTowns/itowns/commit/9c45d72))
* **deps:** bump qs and express ([e2a5988](https://github.com/iTowns/itowns/commit/e2a5988))
* fix incorrect version bumping script ([#2775](https://github.com/iTowns/itowns/issues/2775)) ([960c766](https://github.com/iTowns/itowns/commit/960c766))
...
* **integration:** rearrangement of jobs and rework on regex (check commit messages) ([11e70f6](https://github.com/iTowns/itowns/commit/11e70f6))
...
* migrate eslint to v9 ([#2781](https://github.com/iTowns/itowns/issues/2781)) ([9f946ad](https://github.com/iTowns/itowns/commit/9f946ad))
* migrate LayerUpdateStrategy to typescript ([f740b72](https://github.com/iTowns/itowns/commit/f740b72))
* migrate scripts to ESM ([#2779](https://github.com/iTowns/itowns/issues/2779)) ([0a9b4aa](https://github.com/iTowns/itowns/commit/0a9b4aa))
* **node:** update to node 24 ([d01b83f](https://github.com/iTowns/itowns/commit/d01b83f))
* **pointcloud:** add priority-based update loop ([#2654](https://github.com/iTowns/itowns/issues/2654)) ([97bdf2a](https://github.com/iTowns/itowns/commit/97bdf2a))
* **pointcloud:** centralize disposal and unit tests ([#2762](https://github.com/iTowns/itowns/issues/2762)) ([42d7709](https://github.com/iTowns/itowns/commit/42d7709))
...
* remove invalid import used in test context ([cd88f82](https://github.com/iTowns/itowns/commit/cd88f82))
* remove npm token as OIDC is now used ([dbbccf9](https://github.com/iTowns/itowns/commit/dbbccf9))
* resolve lint issues for ESLint 9 support ([#2776](https://github.com/iTowns/itowns/issues/2776)) ([609d565](https://github.com/iTowns/itowns/commit/609d565))
...
* update deps of debug ([7131b8e](https://github.com/iTowns/itowns/commit/7131b8e))
...
* upgrade puppeteer to 25.1.0 ([#2788](https://github.com/iTowns/itowns/issues/2788)) ([de225a0](https://github.com/iTowns/itowns/commit/de225a0))
...
* Refresh README and Contributing ([b344c80](https://github.com/iTowns/itowns/commit/b344c80))
* **TileMesh:** update and refine documentation ([0e90f3e](https://github.com/iTowns/itowns/commit/0e90f3e))
* Update README.md ([47a1ee5](https://github.com/iTowns/itowns/commit/47a1ee5))
...
* **vectortile:** remove private token ([1ae1d9a](https://github.com/iTowns/itowns/commit/1ae1d9a))
